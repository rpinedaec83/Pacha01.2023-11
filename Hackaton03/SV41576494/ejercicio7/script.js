//Hacer un algoritmo en JavaScript para una tienda de helados que da un descuento por compra a sus clientes con membresía 
...
function ejercicio07(){
    let tot;
    let memb = prompt("ingrese el tipo de membresía: ")
