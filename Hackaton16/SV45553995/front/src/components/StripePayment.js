...
function StripePayment() { 
  ...
  const makePayment = async () => { 
    const stripe = await loadStripe("pk_test_51Owx6TI1DxYnIkC3mSxZHHo2MkKjim6cQZLHBZNw2FiOBmPERHao2ZWdb5DDx9a5aqhDzvsg55pY6Klk0O2q1IpY00kFIomUoT"); 
    const body = { product }; 
    const headers = { 
