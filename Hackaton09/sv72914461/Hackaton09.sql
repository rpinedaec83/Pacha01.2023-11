...
-- 43Calcular el stock de productos por cada categoria.Mostrar el
...
-- 44Obtener el Nombre del cliente,Nombre del Proveedor,Nombre 
...
-- 45Mostrar el numero de ordenes de cada uno de los clientes 
...
-- 46Contar el numero de ordenes que se han realizado por 
...
-- 47Seleccionar el nombre de la compañía del cliente,él código 
